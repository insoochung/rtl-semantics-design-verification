...
with open(
    os.path.join(os.path.dirname(__file__), "var_maps/pretrained_to_trained.json"), "r"
) as f:
...
def get_lr_schedule(lr, lr_scheme, decay_rate=0.90, decay_steps=500, warmup_steps=1000):
