...
from nn.train import get_d2v_model, compile_model_for_training, set_model_flags
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--project_name", type=str, default="d2v", help="Name of the project."
    )
    parser.add_argument(
        "--objective",
        type=str,
    ...
    parser.add_argument(
        "--max_epochs", type=int, default=30, help="Max epochs per search iteration."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Comma separated list of hparams keys to search " "for.",
    )
